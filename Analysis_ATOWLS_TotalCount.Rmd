...
ATOWLS_Grid <- readOGR(dsn="C:/Users/dethier/Documents/ethier-scripts/Atlantic-NOS/Data", layer="ATGrid_50Kv2")
...
post_sum$prov <- grid_key$StateProvince[cells_with_counts]

#summary(post_sum)

#need to back assign the factor grid_id to its original value
id_grid<-sp.data %>% ungroup() %>% dplyr::select(grid_id, alpha_i) %>% distinct()
